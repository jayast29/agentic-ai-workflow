...
class StarkAgent():
    ...
    def __init__(self):
        ...
        self.agent = Agent(
                    ...
                    goal="Answer questions about Stark's availability.",
                    backstory="You are a helpful scheduling assistant who checks Stark's calendar.",
    ...
    async def invoke(self, user_question):
        try:
            task = Task(
                ...
                expected_output="A clear answer about Stark's availability.",
                agent=self.agent
            )
            ...
            print(f"[ERROR] stark_agent.invoke: {e}")
